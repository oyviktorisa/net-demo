...
export class WeatherServiceProxy {
     ...
     * @return Success
     */
    getCurrentWeather(query: GetWeatherDto): Observable<WeatherDto> {
        let url_ = this.baseUrl + "/api/services/app/WeatherService/GetCurrentWeather?";
        if (query.city === null || query.country === null)
            throw new Error("The parameter cannot be null.");
        else if (query !== undefined) {
            url_ += "Country=" + encodeURIComponent("" + query.country) + "&";
            url_ += "City=" + encodeURIComponent("" + query.city) + "&";
        }
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetCurrentWeather(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCurrentWeather(<any>response_);
                } catch (e) {
    ...
    protected processGetCurrentWeather(response: HttpResponseBase): Observable<WeatherDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getLocation(parent: string | undefined): Observable<LocationDtoResultDto> {
        let url_ = this.baseUrl + "/api/services/app/WeatherService/GetLocation?";
        if (parent !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LocationDtoResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<LocationDtoResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetLocation(response: HttpResponseBase): Observable<LocationDtoResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = LocationDtoResultDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LocationDtoResultDto>(<any>null);
    }
}
...
export class LocationDtoResultDto implements ILocationDtoResultDto {
    items: LocationDto[] | undefined;

    constructor(data?: ILocationDtoResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LocationDtoResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new LocationDtoResultDto();
        result.init(data);
        return result;
    }
...
export interface ILocationDtoResultDto {
    items: LocationDto[] | undefined;
}

export class GetWeatherDto implements IGetWeatherDto {
    country: string | undefined;
    city: string | undefined;

    constructor(data?: IGetWeatherDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetWeatherDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetWeatherDto();
        result.init(data);
        return result;
    }
...
export class WeatherDto implements IWeatherDto {
    ...
    skyConditions: string | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.skyConditions = data["skyConditions"];
    ...
    toJSON(data?: any) {
        ...
        data["windDeg"] = this.windDeg;
        data["visibility"] = this.visibility;
        data["skyConditions"] = this.skyConditions;
